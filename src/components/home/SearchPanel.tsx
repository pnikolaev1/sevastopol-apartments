      ...
      <div className="flex flex-col gap-2.5 sm:flex-row">
        <div className="min-w-0 flex-1 rounded-[14px] bg-white px-4 py-2.5">
          ...
          <input
            ...
            className="min-h-5 w-full min-w-0 appearance-none bg-transparent text-[13px] text-[#22303B] outline-none [color-scheme:light] [&::-webkit-date-and-time-value]:text-left"
          />
        </div>
        <div className="min-w-0 flex-1 rounded-[14px] bg-white px-4 py-2.5">
