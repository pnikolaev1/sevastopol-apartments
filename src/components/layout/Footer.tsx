  ...
  return (
    <footer className="mt-auto border-t border-gold/18 bg-navy">
      <div className="container mx-auto px-4 py-14 max-w-7xl">
        ...
        <div className="border-t border-white/10 mt-10 pt-7 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/30">
          <p>{t("rights", { year })}</p>
          <div className="flex items-center gap-5">
            ...
            <Link href="/legal/cookies" className="hover:text-white/60 transition-colors">
              {t("cookies")}
            </Link>
          </div>
        </div>
