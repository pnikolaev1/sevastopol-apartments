  ...
  return (
    <footer className="bg-foreground text-background/80 mt-auto">
      <div className="container mx-auto px-4 py-12 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm leading-relaxed max-w-sm">
              3 private apartments in Varna, Bulgaria — steps from the Black Sea beach and the Sea Garden park.
            </p>
          </div>

          {/* Quick links */}
          <div>
            <h3 className="text-background font-semibold mb-3 text-sm uppercase tracking-wider">
              Pages
            </h3>
            <ul className="space-y-2 text-sm">
              {[
                ...
                <li key={href}>
                  <Link href={href} className="hover:text-background transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
        ...
        <div className="border-t border-background/20 mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
          <p>{t("rights", { year })}</p>
          <div className="flex items-center gap-4">
            ...
            <Link href="/legal/cookies" className="hover:text-background transition-colors">
              {t("cookies")}
            </Link>
          </div>
        </div>
